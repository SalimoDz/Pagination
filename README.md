# Pagination
A js script for manual pagination (array of pages) with dynamic pages ribbon

# First Step

Add the html part for pagination : for me i used an unordered list <ul>

```html
<ul class="pagination row d-flex justify-content-center">
				<li class="page-item previousp"><a class="page-link" href="#"><</a></li>
				<li id="firstp" class="page-item active"><a class="page-link" href="<?php echo base_url("Tuto/FileSharing"); ?>">1</a></li>

				<li id="lastp" class="page-item"><a class="page-link lastpage" href="<?php echo base_url("Tuto/LastPage"); ?>">Last</a></li>
				<li  class="page-item nextp"><a class="page-link" href="#">></a></li>
			</ul>
```
...
Add the JS part for pagination. My script work with 3 steps (3 pages) based on input array, it work with specific declaration of an array : **var array = ['...',2,3,4,'...',5]/['...',2,3,4]/['...',2,3]/['...',2]** 

```diff 
- but not like this ['...',2,3,4,'...']
```

This script is based on retrieving the pages number from the last part of the URL, and then split the string to get the number and then check if the number exist in the array to process the pagination.
...
![alt text](https://github.com/SalimoDz/Pagination/blob/master/PaginationDemo.JPG)


# Improvements

Feel free to help me improve it and make it more elegant and dynamic, also correct me if i did mistakes. Thank you.
